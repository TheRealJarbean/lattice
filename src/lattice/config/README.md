...
# Manual Config
Make sure you understand the basics of [YAML](https://en.wikipedia.org/wiki/YAML) before editing. YAML is loaded in python as a dictionary, so *don't change the structure of the file* unless you plan to edit code.