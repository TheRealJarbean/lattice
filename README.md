- /venv/Scripts contains many helpful scripts used in designing/updating this software (mostly pyside6 tools)
- https://www.pythonguis.com/tutorials/pyside6-embed-pyqtgraph-custom-widgets/

How to use logger:
- In the top level (main) file the logger is configured
...
- Run application with "$env:LOG_LEVEL = "DEBUG"; python .\src\mbe_software\main.py"